...
// REMOVED for Advantage kit - Kav1n
...
public class TunerConstants {
  ...
  // When using closed-loop control, the dxxrive motor uses the control
  // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(0.1).withKI(0).withKD(0).withKS(0.19829).withKV(0.98188);
